...
module.exports = {
    crear: async function (req, res) {
      ...
      listar: async function (req, res) {
        ...
        try {
          const mensajes = await Mensaje.find({id_usuario_envia: id, id_usuario_recibe: usuarioId}).sort('fecha_envio ASC').populate("id_usuario_envia").populate("id_usuario_recibe");
